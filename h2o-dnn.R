# Original code post: https://www.kaggle.com/c/otto-group-product-classification-challenge/forums/t/14134/deep-learning-h2o-0-44
# Unmodified!

library(h2o)
localH2O <- h2o.init(nthread=64)
